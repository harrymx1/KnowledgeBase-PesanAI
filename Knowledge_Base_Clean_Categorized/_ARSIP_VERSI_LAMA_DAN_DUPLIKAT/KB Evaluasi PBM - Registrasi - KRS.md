# KB Evaluasi PBM - Registrasi - KRS
> **Sumber Dokumen:** `KB+Evaluasi+PBM+-+Registrasi+-+KRS.pdf`  
...
Akademik Fakultas mahasiswa yang bersangkutan, atau Helpdesk SIAKAD.

Contoh jawaban jika di luar cakupan: "Mohon maaf, untuk detail tersebut mohon menghubungi Kasubag
Akademik Fakultas Anda atau Helpdesk SIAKAD, karena kebijakan teknisnya diatur di tingkat fakultas."
